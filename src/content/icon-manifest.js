export const iconManifest = [
  ...
  { applicationId: "gallery-folder", label: "Gallery", imageSource: "assets/img/new-collection.webp", fallbackText: "GL", alt: "Gallery folder", action: "gallery-folder", enabled: true, desktop: true, mobile: true, sortOrder: 2 },
  { applicationId: "memory", label: "Memory Card", imageSource: "assets/img/smiley-black.png", fallbackText: "MC", alt: "Memory Card", action: "memory", enabled: true, desktop: true, mobile: true, sortOrder: 3 },

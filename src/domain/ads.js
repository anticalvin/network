...
export const DEFAULT_ADS = Object.freeze([
  { id: "security-memory", enabled: true, type: "security", title: "AWAKEN DEMO DISC / MEMORY RECOVERY", copy: "Unregistered save fragments were found. Insert Memory Card to recover bonus archive data.", weight: 3, minimum_session_age_ms: 45_000, cooldown_ms: 600_000, maximum_per_session: 1, maximum_per_day: 2, eligible_contexts: ["desktop"], excluded_contexts: ["gallery-dirty", "admin", "upload", "text-input"], action_type: "recover", content_reference: "AWAKEN DEMO 01 / recovery-default", requires_memory_card_space: true },
  { id: "messenger-unknown", enabled: true, type: "messenger", title: "AWAKEN MAGAZINE INSERT", copy: "A message was left on Side B. Open the archive insert to continue.", weight: 2, minimum_session_age_ms: 90_000, cooldown_ms: 900_000, maximum_per_session: 1, maximum_per_day: 1, eligible_contexts: ["desktop"], excluded_contexts: ["gallery-dirty", "admin", "upload", "text-input"], action_type: "message", content_reference: "ISSUE XP / mind-recent", requires_mind_data: true },
  { id: "dialer-connection", enabled: true, type: "dialer", title: "CALL-AWAKEN ONLINE DISC", copy: "NETWORK ADAPTER READY / GUEST PASS ACCEPTED / CONNECT SIDE A", weight: 1, minimum_session_age_ms: 120_000, cooldown_ms: 1_800_000, maximum_per_session: 1, maximum_per_day: 1, eligible_contexts: ["desktop"], excluded_contexts: ["gallery-dirty", "admin", "upload", "text-input"], action_type: "connect", content_reference: "CALL-AWAKEN DEMO CHANNEL" }
]);
